...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default='./Dataset/train_32x32.mat', type=str)
    ...
    trainset_loader = DataLoader(trainset, batch_size=8, shuffle=True, num_workers=0)
    # valset = Cifar100(X_val, Y_val, transform=val_transform)
    valset = Cifar10(X_val, Y_val, transform=val_transform)
    valset_loader = DataLoader(valset, batch_size=8, shuffle=False, num_workers=0)
